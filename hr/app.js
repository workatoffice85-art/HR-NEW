...
// Cache with timestamps for performance
let dataCache = {
    attendance: { data: [], timestamp: 0, ttl: 30000 }, // 30 seconds
    employees: { data: [], timestamp: 0, ttl: 60000 }, // 1 minute
    sites: { data: [], timestamp: 0, ttl: 60000 }, // 1 minute
    siteRequests: { data: [], timestamp: 0, ttl: 30000 }, // 30 seconds
    allowanceRequests: { data: [], timestamp: 0, ttl: 30000 }, // 30 seconds
    settings: { data: {}, timestamp: 0, ttl: 120000 }, // 2 minutes
    officialHolidays: { data: [], timestamp: 0, ttl: 300000 } // 5 minutes
};
...
async function fetchEmployees(force = false) {
    ...
    try {
        ...
        if(result.success) {
            ...
            setCache('employees', result.data);
            populateEmployeeDetailEmployees();
            renderEmployeesTable(allEmployees);
        }
    } catch(e) { console.error(e); }
